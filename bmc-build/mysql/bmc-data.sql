...
-- My Account
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.my.accountdetail','/account/fetchMyAccountDetail.action');
...
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.myaccount','/setting/account/fetchMyAccountInfo.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.myaccount','/setting/account/modifyPhoneNumber.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.setting.myaccount','bmc.account.setting','我的帐号','My Account',false,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.password','/setting/password/fetchPasswordStrategy.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.password','/setting/password/modifyPassword.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.setting.password','bmc.account.setting','修改密码','Modify Password',false,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.idletimeout','/setting/idletimeout/fetchIdletimeout.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.setting.idletimeout','/setting/idletimeout/modifyIdletimeout.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
...
-- Account
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.list','/account/fetchAccountInfoList.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.list','bmc.account.management','帐号','Account List',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.new','/account/new/fetchRoles.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.new','/account/addAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.new','bmc.account.list','增加帐号','Add Account',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.authorize','/account/authorize/fetchRoles.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.authorize','/account/authorize/fetchAccountRoles.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.authorize','/account/authorizeAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.authorize','bmc.account.list','授权帐号','Authorize Account',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.disable','/account/disableAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.disable','bmc.account.list','禁用帐号','Disable Account',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.enable','/account/enableAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.enable','bmc.account.list','启用帐号','Enable Account',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.unlock','/account/unlockAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.unlock','bmc.account.list','解锁帐号','Unlock Account',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.password.reset','/account/resetPassword.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.password.reset','bmc.account.list','重置密码','Reset Password',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.delete','/account/deleteAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
...
-- Role
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.list','/role/fetchRoles.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.role.list','bmc.account.management','角色','Role List',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.view','/role/fetchRoleInfo.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.role.view','bmc.role.list','查看角色','View Role',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.new','/role/newRole.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.new','/role/addRole.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.role.new','bmc.role.list','增加角色','New Role',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.edit','/role/editRole.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.edit','/role/modifyRole.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.role.edit','bmc.role.list','编辑角色','Edit Role',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.role.delete','/role/deleteRole.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
...
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.strategy','/system/fetchAccountStrategy.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.strategy','/system/modifyAccountStrategy.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.account.strategy','bmc.security.management','帐号策略','Account Strategy',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.password.strategy','/system/fetchPasswordStrategy.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.password.strategy','/system/modifyPasswordStrategy.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.password.strategy','bmc.security.management','密码策略','Password Strategy',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.online','/system/fetchOnlineAccounts.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.account.online','/system/logoffOnlineAccount.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
...
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.auditlog.operation','/auditlog/fetchOperationLogs.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.auditlog.operation','bmc.auditlog.management','操作日志','Operation Log',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.auditlog.security','/auditlog/fetchSecurityLogs.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.auditlog.security','bmc.auditlog.management','安全日志','Security Log',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.auditlog.system','/auditlog/fetchSystemLogs.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.auditlog.system','bmc.auditlog.management','系统日志','System Log',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.auditlog.api','/auditlog/fetchApiAuditLogs.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
VALUES ('BMC',1,'bmc.auditlog.api','bmc.auditlog.management','接口日志','API Log',true,NULL,NULL);

INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.running.log','/runninglog/fetchRunningLogNames.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.running.log','/runninglog/fetchRunningLogFileNames.action');
INSERT INTO `bmc_perm_resource` (`permName`,`path`) VALUES ('bmc.running.log','/runninglog/downloadRunningLogFile.action');
INSERT INTO `bmc_permission` (`srvId`,`type`,`name`,`parentName`,`displayNameCN`,`displayNameUS`,`isAuthz`,`descriptionCN`,`descriptionUS`) 
...
-- Security data
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('account-strategy', 'accountUnusedDay', 90, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('account-strategy', 'timeLimitPeriod', 10, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('account-strategy', 'loginLimitNumber', 5, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('account-strategy', 'lockTimeStrategy', 1, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('account-strategy', 'accountLockTime', 10, now(), now());

insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('password-strategy', 'historyRepeatSize', 3, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('password-strategy', 'charAppearSize', 2, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('password-strategy', 'modifyTimeInterval', 5, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('password-strategy', 'validDay', 360, now(), now());
insert into bmc_dict_field(domain, key_x, value, utime, ctime) values('password-strategy', 'reminderModifyDay', 15, now(), now());
