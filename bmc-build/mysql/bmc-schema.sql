...
-- -----------------------------------------------------
-- Table `bmc_account_strategy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bmc_account_strategy` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `accountUnusedDay` INT NULL,
  `timeLimitPeriod` INT NULL,
  `loginLimitNumber` INT NULL,
  `lockTimeStrategy` INT NULL,
  `accountLockTime` INT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `bmc_password_strategy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bmc_password_strategy` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `historyRepeatSize` INT NULL,
  `charAppearSize` INT NULL,
  `modifyTimeInterval` INT NULL,
  `validDay` INT NULL,
  `reminderModifyDay` INT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
