 ...
 */
@RestController
public class PasswordExpiredModifyController extends BaseAuditController
{
	private static final Logger LOG = LoggerFactory.getLogger(PasswordExpiredModifyController.class);
	...
	public ActionResponse modifyExpiredPassword(@RequestBody AccountPasswordRequest request)
	{
	...
	{
		return "bmc.account.password.expired.modify.operation";
	}
